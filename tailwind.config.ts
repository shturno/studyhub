	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				'gradient-card': 'linear-gradient(135deg, rgba(0,255,65,0.05) 0%, rgba(0,245,255,0.05) 100%)',
			...
			boxShadow: {
				...
				'glow-green': '0 0 15px rgba(0,255,65,0.5), 0 0 30px rgba(0,255,65,0.2)',
				'glow-pink': '0 0 15px rgba(255,0,110,0.5), 0 0 30px rgba(255,0,110,0.2)',
				'glow-gold': '0 0 15px rgba(255,190,11,0.5), 0 0 30px rgba(255,190,11,0.2)',
