...
6. IMPORTANT: Do NOT create subjects with fewer than 3 topics. If a subject would have only 1-2 topics, do NOT create it as a separate subject. Instead, move its topics into an existing related broader subject. For example, if "Virtualização" has only 1 topic, move that topic into "Automação e Orquestração" or another related subject — never create the small subject at all.
