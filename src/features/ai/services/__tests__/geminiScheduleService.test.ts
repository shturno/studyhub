...
describe('Gemini Schedule Service', () => {
  ...
  describe('Schedule Consistency', () => {
    ...
    it('should have reasonable average daily hours', () => {
      ...
      expect(schedule.fullScheduleOverview.averageDailyHours).toBeGreaterThan(0)
    ...
    it('should have peak intensity week within study period', () => {
      ...
      expect(schedule.fullScheduleOverview.peakIntensityWeek).toBeGreaterThan(0)
      expect(schedule.fullScheduleOverview.peakIntensityWeek).toBeLessThanOrEqual(
        schedule.weeks
      )
    })
  })
  ...
  describe('Topic Coverage Tracking', () => {
    it('should track topics with sessions and hours', () => {
      ...
      const mediumPriority = schedule.fullScheduleOverview.topicsCoverage.filter(
        (t) => t.priority === 'medium'
      )
      ...
      const mediumHours = mediumPriority.reduce((sum, t) => sum + t.totalHours, 0)
