    ...
    return (
        <div style={{ border: '2px solid rgba(0,255,65,0.4)', background: '#04000a' }}>
            <div className="flex items-center gap-2 px-5 py-3"
                ...
                <span className="font-pixel text-[8px] text-[#00ff41]">SESSOES RECENTES</span>
            </div>
                        ...
                        {sessions.map((session) => (
                            ...
                            >
                                <div className="space-y-0.5">
                                    <div className="font-mono text-base text-[#e0e0ff]">{session.topicName}</div>
                                ...
                                <div className="text-right">
                                    <div className="font-pixel text-[8px] text-[#ffbe0b]">+{session.xpEarned} XP</div>
                                    <div className="font-mono text-sm text-[#555]">{session.minutes} min</div>
                                </div>
                            </div>
                        ))}
                    </div>
