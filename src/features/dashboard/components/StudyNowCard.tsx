...
export function StudyNowCard({ nextTopic }: StudyNowCardProps) {
    ...
    if (!nextTopic) {
        return (
            <div className="col-span-full py-12 flex flex-col items-center justify-center text-center"
                ...
                <div className="font-pixel text-[8px] text-[#555] mb-2">NENHUM CICLO ATIVO</div>
    ...
    return (
        <div className="col-span-full p-6" style={{
            ...
            <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-pixel text-[8px] text-[#00ff41]">ESTUDAR AGORA</span>
            </div>

            <div className="mb-4">
                <div className="font-pixel text-lg text-[#00ff41] mb-1"
            ...
            <div className="flex items-center gap-2 text-[#555] mb-6">
                ...
                <span className="font-mono text-base">{nextTopic.estimatedMinutes} minutos</span>
            </div>
