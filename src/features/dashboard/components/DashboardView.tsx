    ...
    if (!user) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-8">
                <div className="font-pixel text-[#00ff41] text-2xl"
                    style={{ textShadow: '0 0 20px rgba(0,255,65,0.8)' }}>
                    GAME OVER
                </div>
                <div className="font-mono text-xl text-[#7f7f9f]">Banco de dados vazio.</div>
                <code className="font-pixel text-[8px] text-[#ffbe0b] px-4 py-2"
                    style={{ border: '2px solid #ffbe0b' }}>npm run db:seed</code>
            </div>
        )
    }
    ...
    if (contests.length === 0) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center">
                <div className="font-pixel text-[#00ff41] text-xl mb-4"
                    style={{ textShadow: '0 0 20px rgba(0,255,65,0.8)' }}>
                    PLAYER 1
                </div>
                ...
                <Link href="/contests">
                    <button className="font-pixel text-[10px] text-black bg-[#00ff41] px-8 py-4"
        ...
        <div className="min-h-screen bg-[#080010] p-4 md:p-6 space-y-6">
            ...
            <div className="flex items-center justify-between p-3"
                ...
                <div className="text-center">
                    ...
                    <div className="font-pixel text-2xl text-[#ffbe0b]"
                ...
                <div className="text-right">
                    ...
                    <div className="font-pixel text-[10px] text-[#ff006e]"
                    ...
                    {randomTopic ? (
                        <>
                            ...
                            <Link href={`/study/${randomTopic.id}`}>
                                <button className="font-pixel text-[10px] text-black bg-[#00ff41] px-6 py-3 flex items-center gap-3"
                                    style={{ boxShadow: '4px 4px 0px #006b1a, 0 0 15px rgba(0,255,65,0.4)' }}>
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4" style={{ border: '2px solid #ff006e', background: '#04000a' }}>
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="font-pixel text-2xl text-[#ff006e]"
                        ...
                        <div className="mt-3 h-4" style={{ background: '#080010', border: '2px solid #ff006e' }}>
                            <div className="h-full"
                                style={{
                                    ...
                                    background: 'repeating-linear-gradient(90deg, #ff006e 0px, #ff006e 10px, transparent 10px, transparent 14px)',
                    ...
                    <div className="p-4" style={{ border: '2px solid #ffbe0b', background: '#04000a' }}>
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="font-pixel text-xl text-[#ffbe0b]"
                                style={{ textShadow: '0 0 10px rgba(255,190,11,0.8)' }}>
                                {user.xp}
                            </span>
                    ...
                    <Link href="/subjects">
                        <div className="p-4 hover:bg-[#00f5ff]/5 transition-colors cursor-pointer"
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-pixel text-[7px] text-[#00f5ff]">MEUS CONTEUDOS</span>
            ...
            <div style={{ border: '2px solid rgba(0,255,65,0.4)', background: '#04000a' }}>
                <div className="px-4 py-3 flex items-center justify-between"
                    ...
                    <span className="font-pixel text-[8px] text-[#00ff41]">── RECENT ACTIVITY ──</span>
                ...
                {recentSessions.length > 0 ? (
                    <div>
                        ...
                        {recentSessions.map((session) => (
                            <div key={session.id}
                                ...
                                <span className="col-span-5 text-[#e0e0ff] truncate">{session.topic.name}</span>
                                <span className="col-span-3 text-[#7f7f9f] truncate">{session.topic.subject.name}</span>
                                <span className="col-span-2 text-right text-[#ffbe0b]">+{session.xpEarned}</span>
                                <span className="col-span-2 text-right text-[#7f7f9f] text-sm">
                                    {formatDistanceToNow(new Date(session.completedAt), { addSuffix: false, locale: ptBR })}
                                </span>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="p-8 text-center">
                        <div className="font-pixel text-[8px] text-[#7f7f9f] mb-2">NO RECORDS YET</div>
