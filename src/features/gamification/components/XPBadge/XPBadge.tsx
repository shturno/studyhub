...
import { getLevelProgress } from "@/features/gamification/utils/xpCalculator";
...
export function XPBadge({ currentXP, currentLevel, className }: XPBadgeProps) {
  ...
  const nextLevelXP =
    currentLevel < 25 ? currentLevel * (currentLevel + 1) * 50 : Infinity;
        ...
        <TooltipTrigger asChild>
          <div className={`flex items-center gap-4 ${className ?? ""}`}>
            ...
            >
              ...
              <span
                className="font-pixel text-sm text-[#ffbe0b]"
