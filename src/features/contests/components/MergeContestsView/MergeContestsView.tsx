...
import { useMergeContestsView } from "./useMergeContestsView";
import type { MergeContestsViewProps } from "./types";

export function MergeContestsView({
  availableContests,
}: MergeContestsViewProps) {
  const { selectedIds, isFusing, toggleSelection, handleFuse } =
    useMergeContestsView();
