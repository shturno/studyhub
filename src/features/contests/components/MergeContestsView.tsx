...
export function MergeContestsView({ availableContests }: MergeContestsViewProps) {
    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6"
                style={{ border: '2px dashed rgba(255,0,110,0.5)', background: '#090004' }}>
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        <Beaker className="w-8 h-8 text-[#ff006e]" />
                        <h2 className="font-pixel text-xl text-[#ff006e]" style={{ textShadow: '0 0 15px rgba(255,0,110,0.6)' }}>
                            O ALQUIMISTA
                        </h2>
                    </div>
                    <p className="font-mono text-sm text-[#7f7f9f]">
                        Selecione 2 ou mais concursos para combinar matérias repetidas e criar um Super-Ciclo de Estudos Otimizado.
                    </p>
                </div>
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="w-5 h-5 flex items-center justify-center shrink-0" 
                                    style={{ border: '2px solid', borderColor: isSelected ? '#ff006e' : '#555', background: isSelected ? '#ff006e' : 'transparent' }}>
                                    {isSelected && <span className="text-[#04000a] text-xs font-bold leading-none">✓</span>}
                                </div>
                            </div>
