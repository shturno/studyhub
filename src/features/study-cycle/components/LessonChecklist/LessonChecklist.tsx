...
import { useLessonChecklist } from "./useLessonChecklist";
import type { LessonChecklistProps } from "./types";
    ...
    return (
      ...
      >
        ...
        <div className="font-mono text-base text-[#444]">
          Adicione lições para estudar esta trilha
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="space-y-2">
        {lessons.map((lesson) => {
          const totalStudyTime = lesson.studyLogs.reduce(
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex-1">
                      ...
                      {lesson.description && (
                        <div className="font-mono text-sm text-[#7f7f9f] mt-0.5">
                          {lesson.description}
                        </div>
                      )}
                    </div>
