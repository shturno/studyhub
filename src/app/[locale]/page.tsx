...
const FEATURES = [
  {
    icon: "🧠",
    title: "ADHD-FRIENDLY",
    desc: "Short sessions, clear goals, no noise",
    color: "#00ff41",
  },
  {
    icon: "🏆",
    title: "GAMIFIED",
    desc: "XP, levels, achievements, and real ranking",
    color: "#ffbe0b",
  },
  {
    icon: "⚡",
    title: "ADAPTIVE AI",
    desc: "AI-generated study cycles",
    color: "#ff006e",
  },
  {
    icon: "🗂️",
    title: "ALL-IN-ONE",
    desc: "Syllabus, subjects, and exams in one place",
    color: "#00e5ff",
  },
];
          ...
          <div className="flex items-center gap-1">
            ...
            <span
              style={{
                fontSize: 13,
                color: "#ff006e",
                textShadow: "0 0 12px #ff006e, 0 0 24px rgba(255,0,110,0.5)",
                letterSpacing: 2,
              }}
            >
              HUB
            ...
            <Link href="/register">
              <button
                ...
                style={{
                  ...
                  padding: "8px 16px",
                  letterSpacing: 1,
                  boxShadow: "4px 4px 0 #006b1a, 0 0 16px rgba(0,255,65,0.4)",
                }}
              >
                PLAY
              </button>
        ...
        <section className="flex flex-col items-center text-center w-full max-w-3xl">
          ...
          <h1
            ...
            style={{
              ...
              color: "#00ff41",
              textShadow:
                "0 0 20px #00ff41, 0 0 50px rgba(0,255,65,0.4), 4px 4px 0 #003d10",
          ...
          <p
            ...
            style={{
              ...
              color: "#ff006e",
              textShadow: "0 0 14px #ff006e, 2px 2px 0 #5c0028",
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 24px rgba(0,255,65,0.25), inset 0 0 40px rgba(0,255,65,0.04)",
              padding: "20px 24px",
            }}
          >
            <div className="flex items-center justify-center gap-3 mb-5">
              <div
                style={{ flex: 1, height: 1, background: "rgba(0,255,65,0.4)" }}
              />
              <span
                style={{
                  fontSize: 8,
            ...
            <Link href="/register">
              <button
                ...
                style={{
                  ...
                  padding: "14px 32px",
                  letterSpacing: "0.1em",
                  boxShadow: "6px 6px 0 #006b1a, 0 0 24px rgba(0,255,65,0.5)",
                }}
              >
                ▶ NEW GAME
              </button>
          ...
          <div
            ...
            style={{
              height: 2,
              background:
                "linear-gradient(90deg, transparent, rgba(0,255,65,0.5) 30%, rgba(0,255,65,0.5) 70%, transparent)",
              boxShadow: "0 0 8px rgba(0,255,65,0.3)",
            }}
          />
          ...
          <div
            ...
            style={{ fontSize: 7, color: "#404050", letterSpacing: 1 }}
          >
