    ...
    <div className="min-h-screen bg-[#080010] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-10">
          <div
            className="font-pixel text-[#00ff41] text-xl mb-1"
            style={{
              textShadow:
        ...
        <div
          ...
          style={{
            ...
            background: "#04000a",
            boxShadow: "6px 6px 0px #006b1a, 0 0 30px rgba(0,255,65,0.1)",
          }}
        >
        ...
        <div className="text-center mt-6">
          <span className="font-mono text-base text-[#7f7f9f]">
            Novo por aqui?{" "}
          </span>
          <Link
            href="/register"
            className="font-pixel text-[8px] text-[#00ff41] hover:text-[#ff006e] transition-colors"
          >
            CRIAR CONTA
          </Link>
        </div>
