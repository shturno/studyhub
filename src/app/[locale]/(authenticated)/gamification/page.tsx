  ...
  return (
    <div className="min-h-screen bg-[#080010] p-4 md:p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          {
            icon: <Zap className="w-5 h-5 text-[#00f5ff]" />,
            value: stats.totalSessions,
            label: "SESSOES",
            color: "#00f5ff",
          },
          {
            icon: <Clock className="w-5 h-5 text-[#00ff41]" />,
            value: `${stats.totalHours}h`,
            label: "HORAS",
            color: "#00ff41",
          },
          {
            icon: <Trophy className="w-5 h-5 text-[#ffbe0b]" />,
          ...
          >
            ...
            <div>
              <div className="font-pixel text-xl" style={{ color: stat.color }}>
                {stat.value}
              </div>
              <div className="font-pixel text-[7px] text-[#7f7f9f] mt-1">
                {stat.label}
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        {achievements.length === 0 ? (
          <div
            className="py-12 text-center font-pixel text-[8px] text-[#555]"
