...
test.describe('Editorial Page Selection Feature', () => {
  ...
  test('should disable "EXTRAIR MATÉRIAS" when role is empty', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
  ...
  test('should disable "EXTRAIR MATÉRIAS" when page ranges are empty', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
  ...
  test('should disable "EXTRAIR MATÉRIAS" when file is not selected', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
  ...
  test('should enable "EXTRAIR MATÉRIAS" when all three fields are filled', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
  ...
  test('should display selected filename after file selection', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
  ...
  test('should show "Trocar Arquivo" button after file selection', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
  ...
  test('should clear file selection when clicking "Trocar Arquivo"', async ({ page }) => {
    const button = page.locator('button:has-text("NOVO EDITAL")')
    await button.click()
